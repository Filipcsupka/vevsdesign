...
const RENTAL_CATEGORIES: RentalCategory[] = [
  {
    ...
    offers: [
      {
        id: "ikebana-na-stoly",
        title: "Ikebana na stoly so sviečkami a živým kvetom",
        price: "35 €",
        unitPrice: 35,
        priceKind: "fixed",
      ...
      },
      {
        ...
        title: "Ikebana na stoly s 8 vázami okolo",
        price: "Od 45 €",
        unitPrice: 45,
        priceKind: "from",
        description: "Obsahuje všetky kvety ako na fotke vo Vašich požadovaných farbách.",
    ...
    offers: [
      {
        ...
        details: "Záloha za kútik je 50€. Možnosť osobného odberu alebo dopravy s našim aranžmánom v sále v rámci Východného Slovenska pri objednávke nad 100 € (+ príplatok PHM).",
      },
    ],
  },
  {
    ...
    offers: [
      ...
      {
        id: "stojan-oval-s-bocnymi-vlnami",
        title: "Stojan ovál s bočnými vlnami",
        price: "100 €",
        unitPrice: 100,
        priceKind: "fixed",
        hideQuantityField: true,
        description: "Oválny stojan s vlnovým návlekom a bočnými vlnami s návlekmi.",
        lead: "Obsahuje vlnový návlek a bočné vlny s návlekom. Nádherne vynikne pri vchode, za novomanželmi alebo na obrade.",
        details: "Výrazný, no stále jemný detail, ktorý priestor elegantne zarámuje.",
      },
      {
  ...
  },
  {
    ...
    offers: [
      ...
      },
      {
        ...
        unitPrice: 2,
        priceKind: "from",
        description: "Jemne zmäkčí prestretie a prepojí celú výzdobu do elegantného celku. Máme na výber modrú, zelenú, ružovú, béžovú, bielu, perličkovú. Cena 2€ je za dĺžku 1,8 m a 2,50€ za dĺžku 3 m.",
        lead: "Jemne zmäkčí prestretie a prepojí celú výzdobu do elegantného celku. Máme na výber modrú, zelenú, ružovú, béžovú, bielu, perličkovú. Cena 2€ je za dĺžku 1,8 m a 2,50€ za dĺžku 3 m.",
        details: "Možnosť osobného odberu, zaslania alebo dopravy s našim aranžmánom v sále v rámci Východného Slovenska pri objednávke nad 100€ (+ príplatok PHM).",
      },
      {
        id: "lampase",
