...
const CUSTOM_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    modalDetails: [
      "Zasadací poriadok vo veľkosti A3",
      "Harmonogram svadby",
  ...
  },
  {
    ...
    modalDescription: "Personalizované servítky jemne doplnia prestretie a prepoja svadobné detaily do jedného vizuálneho celku. Servítky sú potlačené Vašimi iniciálkami.",
    modalDetails: [],
...
const GUEST_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    modalDescription: "Omaľovánky s menom dieťatka vytvoria milú spomienku a zároveň deti zabavia počas svadobného dňa aj ďalších príležitostí. Omaľovánka má meno dieťatka pre krajšiu spomienku a je možnosť pridať aj ceruzky za +0,50 €.",
    modalDetails: [],
  ...
  },
  {
    ...
    modalDescription: "Okuliare prinesú do fotenia a svadobnej zábavy hravosť, farbu a uvoľnenú atmosféru. Obsahujú balík okuliarov v 2 požadovaných farbách (2x8ks) s vtipnými nápismi. Každá ďalšia farba s počtom 8ks za +5€.",
    modalDetails: [],
    modalAbout: "Doba doručenia je 5 až 15 pracovných dní.",
    category: "Doplnky pre hostí",
  },
